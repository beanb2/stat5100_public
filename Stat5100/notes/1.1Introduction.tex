...
\question{(Groups) What do each of the symbols mean in (\ref{eq:resid}) and why might they be important?}
...
\question{(Individual) Which of the following models are linear and which are non-linear?
