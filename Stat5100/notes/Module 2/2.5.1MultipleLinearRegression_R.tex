...
\end{verbatim}
\begin{alltt}
\hlkwd{cor_normality_lm}\hlstd{(patient_lm)}
\end{alltt}
\begin{verbatim}
...
\hlkwd{coefficient_confidence_lm}\hlstd{(patient_lm,} \hlkwc{confidence} \hlstd{=} \hlnum{0.86668}\hlstd{,} \hlkwc{simul} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\begin{verbatim}
