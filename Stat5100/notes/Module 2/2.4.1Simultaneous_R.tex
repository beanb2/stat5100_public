...
\hlkwd{coefficient_confidence_lm}\hlstd{(toluca_lm,} \hlkwc{confidence} \hlstd{=} \hlnum{0.95}\hlstd{,} \hlkwc{simul} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\hlkwd{simul_mean_prediction_limits}\hlstd{(toluca_lm, toluca_sites_A,} \hlkwc{confidence} \hlstd{=} \hlnum{0.90}\hlstd{)}
\end{alltt}
\begin{verbatim}
